<?php
	...
	if(isset($_POST['cate_id']) && isset($_POST['pro_id']))
	{
		if(!empty($_POST['cate_id']) && !empty($_POST['pro_id']))
		{
			$cate_id = $_POST['cate_id'];
			$pro_id = $_POST['pro_id'];
			
		    $query = "select id,pro_id,cate_id,pro_title,pro_brand_id,brand_name,pro_oprice,pro_discount,pro_price,pro_desc,pro_quantity,pro_date from products,brands where pro_brand_id = brand_id and cate_id = '".$cate_id."' and pro_id <> '".$pro_id."' and status = 'Available' LIMIT 4";
