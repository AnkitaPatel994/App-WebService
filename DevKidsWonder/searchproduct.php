<?php
	...
	if(isset($_POST['pro_name']) && isset($_POST['cate_id']) && isset($_POST['brand_id']) && isset($_POST['min_price']) && isset($_POST['max_price']))
	{
		if(!empty($_POST['pro_name']) && !empty($_POST['cate_id']) && !empty($_POST['brand_id']) && !empty($_POST['min_price']) && !empty($_POST['max_price']))
		{
		    ...
		    {
		        $query = "select id,pro_id,cate_id,pro_title,pro_brand_id,brand_name,pro_oprice,pro_discount,pro_price,pro_desc,pro_quantity,pro_date from products,brands where pro_brand_id = brand_id and pro_oprice BETWEEN '".$min_price."' and '".$max_price."' and pro_title like '%$pro_name%' and status = 'Available'";
		    }
		    else if($cate_id == "*")
		    {
		        $query = "select id,pro_id,cate_id,pro_title,pro_brand_id,brand_name,pro_oprice,pro_discount,pro_price,pro_desc,pro_quantity,pro_date from products,brands where pro_brand_id = brand_id and pro_oprice BETWEEN '".$min_price."' and '".$max_price."' and pro_brand_id = '".$brand_id."' and pro_title like '%$pro_name%' and status = 'Available'";
		    }
		    else if($brand_id == "*")
		    {
		        $query = "select id,pro_id,cate_id,pro_title,pro_brand_id,brand_name,pro_oprice,pro_discount,pro_price,pro_desc,pro_quantity,pro_date from products,brands where pro_brand_id = brand_id and pro_oprice BETWEEN '".$min_price."' and '".$max_price."' and cate_id = '".$cate_id."' and pro_title like '%$pro_name%' and status = 'Available'";
		    }
			else if($pro_name == "*")
			{
			...
			{
			    $query = "select id,pro_id,cate_id,pro_title,pro_brand_id,brand_name,pro_oprice,pro_discount,pro_price,pro_desc,pro_quantity,pro_date from products,brands where pro_brand_id = brand_id and pro_oprice BETWEEN '".$min_price."' and '".$max_price."' and cate_id = '".$cate_id."' and pro_brand_id = '".$brand_id."' and pro_title like '%$pro_name%' and status = 'Available'";
			}
